...
public class Pi_GUI {
    ...
    //full sun on big table
//    private static final int SLIDE1_DEFAULT = 149;
//    private static final int SLIDE2_DEFAULT = 170;
//    private static final int SLIDE3_DEFAULT = 11;
//    private static final int SLIDE4_DEFAULT = 139;
//    private static final int SLIDE5_DEFAULT = 215;
//    private static final int SLIDE6_DEFAULT = 255;
//    
    //floods only on big table
    private static final int SLIDE1_DEFAULT = 166;//only let in low red
    private static final int SLIDE2_DEFAULT = 200;
    private static final int SLIDE3_DEFAULT = 0;
    private static final int SLIDE4_DEFAULT = 255;
    private static final int SLIDE5_DEFAULT = 120;
    private static final int SLIDE6_DEFAULT = 255;
